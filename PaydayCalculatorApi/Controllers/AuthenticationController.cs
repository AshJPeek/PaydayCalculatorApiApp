...
namespace PaydayCalculatorApi.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        private UserData ValidateCredentials(AuthenticationData data)
        {
            ...
            if (CompareValues(data.Username, "jbond") &&  CompareValues(data.Password, "bond007"))
            {
                return new UserData(1, "James", "Bond", data.Username!);
            }
